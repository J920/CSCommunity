...
import com.android.team920.cscommunity.Home.Adapter.HomeFollowerAdapter;
...
public class FollowerFragment extends Fragment {
    ...
    private HomeFollowerAdapter HomeCardAdapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.followe_recycler);
        itemList = new ArrayList<>();
        itemList.add("سلام عليكم ورحمه الله وبركاته \n" +
                " ادور مصمم من اجل تصميم برنامج \n" +
                "للتواصل 05xxxxx");
        itemList.add("سلام عليكم ورحمه الله وبركاته \n" +
                " ادور مصمم من اجل تصميم برنامج \n" +
                "للتواصل 05xxxxx");
        ...
        itemList.add("سلام عليكم ورحمه الله وبركاته \n" +
                " ادور مصمم من اجل تصميم برنامج \n" +
                "للتواصل 05xxxxx");
        HomeCardAdapter = new HomeFollowerAdapter(this.getContext(), itemList);
